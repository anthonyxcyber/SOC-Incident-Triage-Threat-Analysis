...
1)Alert Review – Email, firewall, or proxy alert ingestion
2)IOC Identification – URLs, domains, IPs, sender artifacts
3)Log Correlation – Email + firewall telemetry
4)Classification – True Positive (TP) or False Positive (FP)
5)Impact Assessment – Prevented vs potential compromise
6)SOC Reporting – Clear, concise incident conclusions
